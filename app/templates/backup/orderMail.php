                                            ...
                                            <tbody>
                                                ...
                                                <?php } ?>
                                                 ...
                                                 <tr style="background: #f6f6f6">
                                                                    ...
                                                                    <td style="padding:1%; font-family:Arial, sans-serif;"> $3.95 </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr style="background: #f6f6f6">
                                                                    <td width="230" style="padding:1%; width:230px; font-family:Arial, sans-serif;"><strong>Grand
                                                                            Total:</strong></td>
                                                                    <td style="padding:1%; font-family:Arial, sans-serif;">$<?php $grand_total = $items_total + 3.95;
