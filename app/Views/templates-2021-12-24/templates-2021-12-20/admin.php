...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:800px; margin:10px auto; border:1px dashed #707070; padding:10px;">
        <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr>
                        <td style="width:266px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                                <tr>
                                    <td style="color:#181A19; font-family: Arial, Helvetica, sans-serif; font-size:15px; text-transform: uppercase;">
                                        <strong>SHIP FROM:</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color:#181A19; font-family: Arial, Helvetica, sans-serif; font-size:15px; padding-top:5px;">
                                        <strong>Earnatural.com</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color:#181A19; font-family: Arial, Helvetica, sans-serif; font-size:15px;">
                                        2390 Crenshaw Blvd Suite #239, Torrance, CA 90501
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td style="width:266px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                                <tr>
                                    <td style="color:#181A19; font-family: Arial, Helvetica, sans-serif; font-size:15px; text-transform: uppercase; text-align: right;">
                                        <strong>SHIP TO:</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color:#181A19; font-family: Arial, Helvetica, sans-serif; font-size:15px; text-align: right; padding-top:5px;">
                                        <strong><?=$orderData['postData']['card_holder_name'];?></strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color:#181A19; font-family: Arial, Helvetica, sans-serif; font-size:15px; text-align: right;">
                                        <?=$orderData['postData']['shipping_address_1'] . ', ' . $orderData['postData']['shipping_address_2'] . ', ' . $orderData['postData']['shipping_city'] . ', ' . $orderData['postData']['shipping_state'] . ', ' . $orderData['postData']['shipping_zip'] ;?>
                                    </td>
                                </tr>
                            </table>
