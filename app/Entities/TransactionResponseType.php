...
class TransactionResponseType implements \JsonSerializable
{
     ...
     * @return self
     */
    public function setPrePaidCard(TransactionResponseType\PrePaidCardAType $prePaidCard)
    {
     ...
     * $message
     */
    public function addToMessages(TransactionResponseType\MessagesAType\MessageAType $message)
    {
     ...
     * $error
     */
    public function addToErrors(TransactionResponseType\ErrorsAType\ErrorAType $error)
    {
        $this->errors[] = $error;
        return $this;
    }
     ...
     * $splitTenderPayment
     */
    public function addToSplitTenderPayments(TransactionResponseType\SplitTenderPaymentsAType\SplitTenderPaymentAType $splitTenderPayment)
    {
     ...
     * @return self
     */
    public function setSecureAcceptance(TransactionResponseType\SecureAcceptanceAType $secureAcceptance)
    {
     ...
     * @return self
     */
    public function setEmvResponse(TransactionResponseType\EmvResponseAType $emvResponse)
    {
